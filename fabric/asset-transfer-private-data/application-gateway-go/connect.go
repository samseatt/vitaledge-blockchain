...
const (
	cryptoPathOrg1        = "../../test-network/organizations/peerOrganizations/clinicians.xmed.ai"
	keyDirectoryPathOrg1  = cryptoPathOrg1 + "/users/User1@clinicians.xmed.ai/msp/keystore"
	certDirectoryPathOrg1 = cryptoPathOrg1 + "/users/User1@clinicians.xmed.ai/msp/signcerts"
