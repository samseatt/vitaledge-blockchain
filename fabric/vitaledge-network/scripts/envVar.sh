...
# where execution occurs from folders outside of default as $PWD, such as the vitaledge-network/addOrg3 folder.
...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/clinicians.xmed.ai/users/Admin@clinicians.xmed.ai/msp
